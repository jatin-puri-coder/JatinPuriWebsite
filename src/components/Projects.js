    ...
    <div className='projects'>
      ...
      <div className='hsplit projbottom'>
        <div className="scrolling-wrapper">
          <div className="card">
            <h2 className='projnames'><a href="https://babycentral.herokuapp.com/" target="_blank" rel='noreferrer'>Baby Central</a></h2>
          ...
          <div className="card">
            <h2 className='projnames'><a href="https://jatin-puri-coder.github.io/Weather/" target="_blank" rel='noreferrer'>Weather App</a></h2>
          ...
          <div className="card">
            <h2 className='projnames'><a href="https://jatin-puri-coder.github.io/Countdown/" target="_blank" rel='noreferrer'>Countdown</a></h2>
          ...
          <div className="card">
            <h2 className='projnames'><a href="https://jatin-puri-coder.github.io/minesweeper/" target="_blank" rel='noreferrer'>Minesweeper</a></h2>
          ...
          <div className="card">
            <h2 className='projnames'><a href="https://jatin-puri-coder.github.io/theneverendingroad/" target="_blank" rel='noreferrer'>The Neverending Road</a></h2>
